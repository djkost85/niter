...
;(function($, window, document, undefined) {
  ...
  $.fn.liquidSlider2 = function(options) {
    return this.each(function() {
      var slider = Object.create(liquidSlider2);
      slider.init(options, this);
      $.data(this, 'liquidSlider2', slider);
    });
  };

  $.fn.liquidSlider2.options = {
    autoHeight: true,
    minHeight: 0,
...
liquidSlider2.init = function(options, elem) {
  var _this = this;
  ...
  // Set the options
  _this.options = jQuery.extend({}, jQuery.fn.liquidSlider2.options, options);
...
liquidSlider2.determineAnimationType = function() {
  var _this = this,
...
liquidSlider2.configureCSSTransitions = function(slide, height) {
  var _this = this,
    slideTransition,
    heightTransition,
    sFunction,
...
liquidSlider2.transitionFade = function() {
  var _this = this;
...
liquidSlider2.setNextPanel = function(direction) {
  var _this = this;
...
liquidSlider2.getFirstPanel = function() {
  var _this = this,
    output;
 ...
 * @return <String>
 */
liquidSlider2.getFromPanel = function(searchTerm, panelNumber) {
  var _this = this;
 ...
 * @return <String>
 */
liquidSlider2.convertRegex = function(input) {
 ...
 */
liquidSlider2.updateClass = function(crosslink) {
  var _this = this;
 ...
 * @return <Number>
 */
liquidSlider2.sanitizeNumber = function(panel) {
  var _this = this;
...
liquidSlider2.finalize = function() {
  var _this = this;
 ...
 * @param <Bool> isFade
 */
liquidSlider2.callback = function(callbackFn, isFade) {
  var _this = this;
 ...
 */
liquidSlider2.prepareTransition = function(nextPanel, noAnimation, noPretransition, noPosttransition) {
  var _this = this;
...
liquidSlider2.pretransition = function() {
  var _this = this;
...
liquidSlider2.getTransitionMargin = function() {
  var _this = this;
...
liquidSlider2.transition = function() {
  var _this = this,
...
liquidSlider2.transitionOutAnimateCSS = function() {
  var _this = this;
...
// TODO run these together
liquidSlider2.transitionInAnimateCSS = function() {
  var _this = this;
...
liquidSlider2.transitionCSS = function(marginLeft, noAnimation) {
  var _this = this;
...
liquidSlider2.transitionjQuery = function(marginLeft, noAnimation) {
  var _this = this;
 ...
 * @param <Number> height
 */
liquidSlider2.getHeight = function(height) {
  var _this = this;
 ...
 * @param <Number> height
 */
liquidSlider2.getHeighestPanel = function() {
  var _this = this,
      height,
      heighest = 0;
 ...
 */
liquidSlider2.verifyPanel = function() {
  var _this = this,
    clickable = false;
 ...
 */
liquidSlider2.addNavigation = function(navClass) {
  var _this = this,
 ...
 */
liquidSlider2.getNavInsides = function(input) {
  return (this.options.dynamicTabsHtml) ? jQuery(input).html() : jQuery(input).text();
};

liquidSlider2.alignNavigation = function() {
  var _this = this,
...
liquidSlider2.registerNav = function() {
  var _this = this;
 ...
 */
liquidSlider2.addArrows = function(arrowClass) {
  var _this = this,
    arrow = (_this.options.dynamicArrowsGraphical) ? "-arrow " : ' ';
 ...
 * @param <Bool> hideBoth
 */
liquidSlider2.hideShowArrows = function(speed, forceVisibility, showBoth, hideBoth) {
  var _this = this,
...
liquidSlider2.registerArrows = function() {
  var _this = this;
 ...
 * @param <Bool> duration
 */
liquidSlider2.adjustHeight = function(noAnimation, height, easing, duration) {
  var _this = this;
...
liquidSlider2.autoSlide = function() {
  var _this = this;
...
liquidSlider2.stopAutoSlide = function() {
  var _this = this;
 ...
 * @param <Bool> reset
 */
liquidSlider2.startAutoSlide = function(reset) {
  var _this = this;
...
liquidSlider2.buildHashTags = function() {
  var _this = this;
...
liquidSlider2.updateHashTags = function() {
  var _this = this;

  window.location.hash = _this.hashLinks[_this.sanitizeNumber(_this.nextPanel) -1];
};

liquidSlider2.registerKeyboard = function() {
  var _this = this;
...
liquidSlider2.addPreloader = function() {
  var _this = this;

  jQuery(_this.sliderId + '-wrapper').append('<div class="ls-preloader"></div>');
};

liquidSlider2.removePreloader = function() {
  var _this = this;
...
liquidSlider2.makeResponsive = function() {
  var _this = this;
...
liquidSlider2.responsiveEvents = function() {
  var _this = this,
...
liquidSlider2.registerTouch = function() {
  var _this = this,
