...
function () {
    ...
    function (t) {
        t("#auto-complete-small").typeahead({
            ...
            template: _.template('<div class="media row animated fadeInDownBig"><a class="pull-left col-sm-2" href="#"><img class="media-object img-responsive" src="<%= poster %>" alt="..."></a><div class="media-body col-sm-8"><h4 class="media-heading"><%= title %></h4><p class="tt-genre"><%= genre %></p></div></div>')
    ...
    function (t) {
        t(window).ready(function () {
            ...
            e.each(function () {
                var e = t(this),
                    n = parseInt(e.text());
                50 >= n ? e.css("border-color", "#FF2E46") : n > 50 && 70 > n ? e.css("border-color", "#e67e22") : n >= 70 && 100 != n ? e.css("border-color", "#27AE60") : 100 == n && (e.css("border-color", "#27AE60"), e.css("padding", "12px 8px 10px 8px"), e.find("span"))
            })
        })
