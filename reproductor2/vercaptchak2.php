<?php
   ...
   //http://api.solvemedia.com/papi/media?c=
    ...
    $header = "Host: api.solvemedia.com\r\n";
    ...
    $fp = fsockopen("api.solvemedia.com",80, $errno, $errstr); // Nos conectamos a Google
    if (!$fp) {
        echo "$errstr ($errno)<br/>\n"; // Mostramos los errores, si hay.
        echo $fp;
    } else {
        fputs($fp, "GET /papi/_challenge.js?k=" . $captcha_code . " HTTP/1.1\r\n"); 
        fputs($fp, $header);
