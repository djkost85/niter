...
class EventListeningServiceProvider extends ServiceProvider {
    ...
    {      
        ...
        //main title page
        View::composer('titles.showNoTabs', function($view) use($options)
        {
        ...
        View::composer('search.results', function($view)
        {
            ...
            $view->withActors($results)->withNews($news)->with( compact('watchlist', 'favorites') );;
        });
        ...
        //attach background url to resetPassword page
        View::composer('users.resetPassword', function($view)
        {
            $options = App::make('Options');
        ...
        //attach background url login page
        View::composer('home.404', function($view)
        {
            $options = App::make('Options');
        ...
        View::composer('dashboard.elements.sidebar', function($view)
        {
            $options = App::make('Options');
        ...
        View::composer('elements.navbar', function($view)
        {
            $options = App::make('Options');
        ...
        View::composer('elements.slider', function($view)
        {
            $options = App::make('Options');
