...
use Lib\Services\Search\SearchAdminProviderInterface;
use Helpers, Title, App, Actor, Exception, Event, Options;


class TmdbDataAdmin implements DataRepositoryInterface, SearchAdminProviderInterface
{
	/**
	 * Api base path.
	 * 
	...
	/**
	 * Get current title created at date.
	 * 
	 * @return string
	 */
	public function getCreatedAt()
	{
		return (array_key_exists('created_at', $this->raw) ? $this->raw['created_at'] : $this->raw['created_at']);
	}
