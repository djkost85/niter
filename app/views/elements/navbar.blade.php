				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="{{ url(Str::slug(trans('main.movies'))) . '?relevance=releases' }}">{{ trans('main.releases') }}</a></li>
							<li><a href="{{ url(Str::slug(trans('main.movies'))) . '?relevance=featured' }}">{{ trans('main.featured') }}</a></li>
							<li><a href="{{ url(Str::slug(trans('main.movies'))) . '?relevance=reindexed' }}">{{ trans('main.reindexed') }}</a></li>
							<li><a href="{{ url(Str::slug(trans('main.movies'))) . '?relevance=popular' }}">{{ trans('main.popular-menu') }}</a></li>
						</ul>
					</li>
