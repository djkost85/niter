...
class MoviesController extends \TitleController {
	...
	public function index()
	{
		...
		if (isset($input['reindexed']))
		{
			$reindexed = $input['reindexed'];
			if ($reindexed == 'on')
			{
			 	$data = $data->reindexed($data);
				$reindexed = true;
			}
		}
		else
		...
		if (isset($input['sortBy']))
			...
			$sortBy = Title::sortByString('releaseDate');	
