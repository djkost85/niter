<div id="filters" class="row btn-row mobile-only">
	<div class="btn-group col-xs-12">
		{{ Form::open(array('url' => $action, 'class' => 'form-inline', 'method' => 'GET')) }}
			...
			<div class="filter row">			
				<div class="label col-xs-4">
					<strong>{{ trans('main.releases') }}:</strong>
				</div>
				<div class="form-group checkbox col-xs-2">
					{{ Form::checkbox('releases', Input::get('releases'), $releases,  array('id' => 'releases')) }}
				</div>
				<div class="label col-xs-4">
					<strong>{{ trans('main.reindexed') }}:</strong>
				</div>
				<div class="form-group checkbox col-xs-2">					
					{{ Form::checkbox('reindexed', Input::get('reindexed'), $reindexed, array('id' => 'reindexed')) }}
				</div>
			</div>
			<div class="filter row">			
				<div class="label col-xs-3">
				...
				<div class="form-group col-xs-9">
					{{ Form::select('sortBy',
					array(	'releaseDate'	=> trans('main.releaseDate'),
							'A-Z'			=> trans('main.az'),
						  	'rating'	=> trans('main.rating'),
						  	'lastAdded'	=> trans('main.lastAdded')),
					Input::get('sortBy') ? e(Input::get('sortBy')) : 'releaseDate', array('class' => 'form-control', 'id' => 'sortBy')) }}
				</div>
			</div>
			<div class="filter row">				
				<div class="label col-xs-3">
				...
				<div class="form-group list-button col-xs-1 col-xs-offset-1">
					<a title="List View" data-view="{{$view}}" href="{{ Request::url() . '?view=0'}}"></a>
				</div>
				<div class="form-group grid-button col-xs-1">
					<a title="Grid View" data-view="{{$view}}" href="{{ Request::url() . '?view=1'}}"></a>
				</div>
