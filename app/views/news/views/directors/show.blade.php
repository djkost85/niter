...
@section('bodytag')
	<body id ="directorDetail" class="body nav-trans animate-nav show transparent-navbar">
@stop
        ...
        <div class="main">
			<div class="row">
				...
				<section class="col-xs-8 col-sm-10">
					...
					<dl class="dl-horizontal row desktop-only">			  
					...
					@if ($actor['awards'])
						<p class="row well actor-awards desktop-only">
				...
				<div class="row actor-known-for">
					...
					@foreach ($known as $v)
						<figure class="col-xs-4 col-sm-2">
							<a href="<?php echo '/movies/'.$v->idTitle.'-'.$v->title ?>">
