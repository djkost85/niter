	...
	<div class="main-content">
		...
		<div id="tabs" class="row desktop-only">
			<ul class="nav nav-tabs" role="tablist">
	  			@if ($releasesCount > 0)
					<li class="active"><a href="#releases" role="tab" data-toggle="tab">{{ trans('main.releases') }}</a></li>
				@endif
	  			@if ($mostPopularCount > 0)
					<li><a href="#mostPopular" role="tab" data-toggle="tab">{{ trans('main.mostpopular') }}</a></li>
				@endif
	  			@if ($lastAddedCount > 0)
		        	<li><a href="#lastAdded" role="tab" data-toggle="tab">{{ trans('main.lastadded') }}</a></li>
				@endif
	  			@if ($reindexedCount > 0)
		        	<li><a href="#reindexed" role="tab" data-toggle="tab">{{ trans('main.reindexed') }}</a></li>
				@endif
	        </ul>
