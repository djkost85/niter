 	...
 	<div class="col-sm-4">
 		<div class="action-block">
		 	...
		 	<div class="scraper-container">
				...
				{{ Form::open(array('url' => 'dashboard/truncate-no-videos')) }}
					{{ Form::hidden('table', 'titles') }}
					{{ Form::hidden('field', 'video') }}
	         		<button type="submit"><i class="fa fa-trash-o"></i> {{ trans('dash.delete titles no video') }}</button>      
	        	{{ Form::close() }}
